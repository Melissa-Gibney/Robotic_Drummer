...
void DrumManager::set_vel_preset(int npreset)
{
  ...
  int preset1_velocities[N_DRUMS][WIN_LEN] = {{127,60,60,60,60,60,60,60},
                                              {60,60,127,60,60,60,60,60},
                                              {60,60,60,60,127,60,60,60},
                                              {60,60,60,60,60,60,127,60}};
  ...
  int preset3_velocities[N_DRUMS][WIN_LEN] = {{102,60,50,60,102,60,50,60},
                                              {60,82,60,53,60,82,60,53},
                                              {70,85,70,60,70,85,60,60},
                                              {120,110,100,90,80,70,60,50}};

  int preset4_velocities[N_DRUMS][WIN_LEN] = {{50,60,60,70,60,70,60,60},
                                              {60,70,60,60,70,60,100,100},
                                              {60,60,120,80,80,60,120,60},
                                              {60,60,90,90,60,50,50,60}};
